...
\usepackage{graphicx}
\usepackage{rotating}
\usepackage[sort]{natbib}	% natbib is available on most systems, and is
					% terribly handy.
...
\usepackage{amsmath, bm}			% AMS Math (advanced math typesetting)
\usepackage{amsbsy}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{gensymb}
...
\usepackage[bookmarks=false, citecolor=black, colorlinks=true, linkcolor=black, urlcolor = black]{hyperref}
\usepackage{xcolor} %this is for comment
\usepackage{graphicx} %used to include graphics in the document
\graphicspath{{./Images/}}
...
% Set up some values.
\completetitle{``Lens-coupled x-ray imaging systems'' }
\fullname{Helen Xiang Fan }			% Grad college wants your full name here.
