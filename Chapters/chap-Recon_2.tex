...
\begin{figure}[h]
\centering
\includegraphics[scale=1]{Radon_transform2.pdf}
...
\centering
\includegraphics[scale = 0.35]{iterative_recon_process}
\end{minipage}
...
\footnotetext{Reprinted from: \textit{Physica Medica}, \textbf{28}, Bester, M., Kolditz, D., and Kalender, W. A., Iterative reconstruction methods in X-ray CT, pp. 94-108, Copyright(2012), with permission from Elsevier.}
...
\footnotetext{Hsieh, J., B. Nett, Z. Yu, K. Sauer, J. B. Thibaut, and C. A. Bouman (2013). Recent Advances in CT Image Reconstruction. \textit{Curr. Radiol. Rep.}, \textbf{1}, pp. 39-51, with kind permission from Springer Science and Business Media.}
...
Once the values from Eq.~\ref{eq:siddon_alpha_extremes} are found, two parametric values that are used to indicate the initial and final intersections of the ray with the object volume are determined using,
%
\begin{equation}
\begin{aligned}
...
Normally, $d$ is calculated using a loop until a desired number of rays are reached.  However, each ray corresponds to one detector element and is independent of each ray.  We can utilize the GPU's parallel computing capability to trace all rays simultaneously by assigning one CUDA thread per ray.
...
\includegraphics[scale=0.80]{siddon_flowchart.eps}
...
\begin{figure*}
	\begin{minipage}{0.3\linewidth}
		\includegraphics[width = 4cm]{Capture_breast_xy2.png}
		\subcaption{}
	\end{minipage}
	\vspace{0.3cm}
	\begin{minipage}{0.3\linewidth}
		\includegraphics[width = 4cm]{Capture_breast_xz2.png}
		\subcaption{}
	\end{minipage}
	\vspace{0.3cm}
	\begin{minipage}{0.3\linewidth}
		\includegraphics[width = 4cm]{Capture_breast_yz2.png}
		\subcaption{}
	\end{minipage}
...
\begin{sidewaysfigure}
\includegraphics[scale=0.8]{mis-calibration_table.pdf}
